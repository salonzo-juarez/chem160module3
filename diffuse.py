...
npart = 300
side = 15  # Should be an odd number
time = 0
...
# I would have edited the program to prevent an index from floating but I wanted to follow the intrustructions you had which did not
# mention altering the list